...
class Transaction:
    ...
    def create_output(self, sender_wallet, recipient, amount):
        """Stracture the output data for the transaction"""
    ...
    def create_input(self, sender_wallet, output):
        """Stracture the input data for the transactionSign the 
        transaction and include the sender's public key and address"""
        return{
    ...
    def from_json(transaction_json):
        """Deserailize a transaction's json repr back into a
    ...
    def is_valid_transaction(transaction):
        ...
        if transaction.input == MININIG_REWARD_INPUT:
            if list(transaction.output.values()) != [MININIG_REWARD]:
    ...
    def reward_transaction(miner_wallet):
        ...
        output = {}
        output[miner_wallet.address] = MININIG_REWARD

        return Transaction(input=MININIG_REWARD_INPUT, output=output)
